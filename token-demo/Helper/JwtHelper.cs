...
namespace token_demo.Helper
{
    public class JwtHelper
    {
        ...
        public string GenerateToken(string userName, List<Claim> customClaim, int expireMinutes = 30)
        {
            ...
            claims.Add(new Claim(JwtRegisteredClaimNames.Sub, userName)); // User.Identity.         
